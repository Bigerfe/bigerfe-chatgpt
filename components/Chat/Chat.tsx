    ...
    <div className="relative flex-1 overflow-none dark:bg-[#343541] bg-white">
      {!apiKey && (
        <div className="flex flex-col justify-center mx-auto h-full w-[300px] sm:w-[500px] space-y-6">
          <div className="text-1xl font-semibold text-center text-gray-800 dark:text-gray-100">Hi,我是程序员饭哥，叫我小饭就行。<br/>爱好互联网、编程、AI领域，做过后端、前端，写过C/C++、Java、Android、PHP，现在做前端领域。</div>
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">如果没有key，请加作者公众号，获取共享KEY。</div>
