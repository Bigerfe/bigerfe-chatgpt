    ...
    <div className="relative flex-1 overflow-none dark:bg-[#343541] bg-white">
      {!apiKey && (
        <div className="flex flex-col justify-center mx-auto h-full w-[300px] sm:w-[500px] space-y-6">
          ...
          <div className="text-center text-gray-500 dark:text-gray-800 dark:text-gray-100">请先在页面左下方设置您的OpenAI API key。</div>
          <div className="text-center text-gray-500 dark:text-gray-800 dark:text-gray-100">如果没有key，请关注作者公众号，直接获取共享KEY。</div>
